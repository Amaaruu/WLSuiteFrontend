...
const Home = () => {
  // Datos de ejemplo para mostrar las mejores plantillas en la Home
  ...
  return (
    <div className="min-h-screen bg-white selection:bg-sapphire-100 font-sans">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center">
            ...
            <h1 className="text-6xl lg:text-8xl font-black text-sapphire-950 mb-8 tracking-tight">
              Crea tu éxito <br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-sapphire-600 via-blue-500 to-sapphire-400">
                con Inteligencia
              </span>
            </h1>
      ...
      <section className="bg-gray-50/80 py-24 border-y border-gray-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8 lg:gap-12">
            {[
              { step: "01", title: "Elige tu Plan", desc: "Selecciona el paquete que mejor se adapte a tu nivel de crecimiento y presupuesto." },
              { step: "02", title: "Habla con la IA", desc: "Describe tu negocio y objetivo. Nuestro modelo generará la estructura y textos persuasivos." },
              { step: "03", title: "Publica y Vende", desc: "Ajusta los detalles en nuestro editor y lanza tu landing page al mercado al instante." }
            ].map((item, idx) => (
              <div key={idx} className="relative p-8 rounded-3xl bg-white border border-gray-100 shadow-sm hover:shadow-lg hover:border-sapphire-100 transition-all group">
